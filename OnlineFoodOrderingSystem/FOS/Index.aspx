<%@ Page Title="" Language="C#" MasterPageFile="~/FOS/FOS.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="OnlineFoodOrderingSystem.FOS.WebForm1" %>
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="display-3 text-white animated slideInLeft">Enjoy Our<br>Kathiyawadi Food</h1>
                            <p class="text-white animated slideInLeft mb-4 pb-2">
                                Every flavor sings of love and care, Moments with food beyond compare.
                                The art of serving, the colors of food, A Thali filled with joy’s mood.<br>
                                Butter-soft Roti, the curry’s tune, Khusbhu spices filling the room.
                                </p>
                            <a href="Login.aspx" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Book A Order</a>
                        </div>
                        <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                            <img class="img-fluid" src="../Asset/Library/img/hero.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.1s" src="../Asset/Library/img/about-1.jpg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.3s" src="../Asset/Library/img/about-2.jpg" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="../Asset/Library/img/about-3.jpg">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.7s" src="../Asset/Library/img/about-4.jpg">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">About Us</h5>
                        <h1 class="mb-4">Welcome to <i class="fa fa-utensils text-primary me-2"></i>kashtabhanjan</h1>
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                                    <h1 class="flex-shrink-0 display-5 text-primary mb-0" data-toggle="counter-up">51</h1>
                                    <div class="ps-4">
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class="rounded-circle overflow-hidden m-4">
                                <img class="img-fluid" src="../Asset/Library/img/team1.png" alt="">
                            </div>
                            <h5 class="mb-0">Shivam Dholeriya</h5>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class="rounded-circle overflow-hidden m-4">
                                <img class="img-fluid" src="../Asset/Library/img/team2.png" alt="">
                            </div>
                            <h5 class="mb-0">Rahul Domadia</h5>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class="rounded-circle overflow-hidden m-4">
                                <img class="img-fluid" src="../Asset/Library/img/team3.png" alt="">
                            </div>
                            <h5 class="mb-0">Divyam Gabani</h5>
                            <small>Jain Food Master Chef</small>
                            <div class="d-flex justify-content-center mt-3">
                                <a class="btn btn-square btn-primary mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-primary mx-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square btn-primary mx-1" href=""><i class="fab fa-instagram"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class="rounded-circle overflow-hidden m-4">
                                <img class="img-fluid" src="../Asset/Library/img/team4.png" alt="">
                            </div>
                            <h5 class="mb-0">Rushi Patel</h5>
                            <small>Assistant Chef</small>
                            <div class="d-flex justify-content-center mt-3">
                                <a class="btn btn-square btn-primary mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-primary mx-1" href=""><i class="fab fa-twitter"></i></a>
