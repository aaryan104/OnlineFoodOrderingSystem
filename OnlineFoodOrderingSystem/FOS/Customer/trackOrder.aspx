                                    ...
                                    <table class="order-table w-full text-left">
                                        <tbody>
                                            ...
                                            <tr class="border-b border-gray-200">
                                                ...
                                                <td class="px-4 py-3"><asp:Label ID="lblContact" runat="server" Text="****"></asp:Label></td>
                                            </tr>
                                            <tr class="border-b border-gray-200">
                                                <td class="px-4 py-3 bg-gray-50 font-medium text-gray-600 w-1/3">Order ID</td>
                                                <td class="px-4 py-3" id="orderIdCell"><asp:Label ID="lblOrderId" runat="server" Text="****"></asp:Label></td>
                                            </tr>
                                            <tr class="border-b border-gray-200">
                                                <td class="px-4 py-3 bg-gray-50 font-medium text-gray-600">Order
                                                    Date</td>
                                                <td class="px-4 py-3"><asp:Label ID="lblOrderDate" runat="server" Text="****"></asp:Label></td>
                                            </tr>
                                            <tr class="border-b border-gray-200">
                                                <td class="px-4 py-3 bg-gray-50 font-medium text-gray-600">Estimated
                                                    Delivery</td>
                                                <td class="px-4 py-3"><asp:Label ID="lblEstimatedDelivery" runat="server" Text="****"></asp:Label></td>
                                            </tr>
                                            <tr class="border-b border-gray-200">
                                                <td class="px-4 py-3 bg-gray-50 font-medium text-gray-600">Shipping
                                                    Address</td>
                                                <td class="px-4 py-3"><asp:Label ID="lblShippingAddress" runat="server" Text="****"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td class="px-4 py-3 bg-gray-50 font-medium text-gray-600">Payment
                                                    Method</td>
                                                <td class="px-4 py-3"><asp:Label ID="lblPaymentMethod" runat="server" Text="****"></asp:Label></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="order-table w-full text-left">
                                            ...
                                            <asp:Repeater ID="rptOrderItems" runat="server">
                                                <ItemTemplate>
                                                    <tr class="border-b border-gray-200">
                                                        ...
                                                        <td class="px-4 py-3"><%# Eval("Quantity") %></td>
                                                        <td class="px-4 py-3">₹<%# Eval("Subtotal", "{0:F2}") %></td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </tbody>
                                        <tfoot class="bg-gray-50">
                                            <tr>
                                                ...
                                                <td class="px-4 py-3 font-semibold"><asp:Label ID="lblTotalAmount" runat="server" Text="₹0.00"></asp:Label></td>
